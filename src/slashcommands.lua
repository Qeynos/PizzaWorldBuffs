...
SlashCmdList['PIZZAWORLDBUFFS'] = function (args, editbox)
  ...
  if command == 'logout' then
    ...
    if PWB.lastReminder then PWB.lastReminder = nil end
    if PWB.logoutAt then PWB.logoutAt = nil end
  ...
  PWB:PrintClean(PWB.Colors.primary .. '   /wb|r interval ' .. PWB_config.interval .. PWB.Colors.grey .. ' - 设置更新间隔\(s\)')
